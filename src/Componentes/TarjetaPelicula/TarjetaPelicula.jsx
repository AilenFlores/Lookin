...
const TarjetaPelicula = ({ pelicula, onClick }) => {
    return (
        <div className="rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 ease-in-out flex flex-col overflow-hidden w-52 m-2"
